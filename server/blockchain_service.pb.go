...
var file_server_blockchain_service_proto_rawDesc = []byte{
	...
	0x73, 0x32, 0x85, 0x03, 0x0a, 0x11, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e,
	...
	0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x41, 0x6d, 0x72, 0x2d, 0x53, 0x68, 0x61, 0x6d,
	0x73, 0x2f, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x65, 0x72, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72,
...
var file_server_blockchain_service_proto_depIdxs = []int32{
	...
	1,  // 10: server.BlockchainService.BroadcastBlock:input_type -> server.Transaction
	6,  // 11: server.BlockchainService.CheckStatus:input_type -> server.Request
	1,  // 12: server.BlockchainService.AddBlock:input_type -> server.Transaction
	6,  // 13: server.BlockchainService.Hello:input_type -> server.Request
	11, // 14: server.BlockchainService.AddPeer:input_type -> server.AddPeerRequest
	7,  // 15: server.BlockchainService.GetPeers:input_type -> server.Empty
	5,  // 16: server.BlockchainService.GetBlockChain:output_type -> server.Response
	5,  // 17: server.BlockchainService.BroadcastBlock:output_type -> server.Response
	5,  // 18: server.BlockchainService.CheckStatus:output_type -> server.Response
	5,  // 19: server.BlockchainService.AddBlock:output_type -> server.Response
	8,  // 20: server.BlockchainService.Hello:output_type -> server.HelloResponse
	12, // 21: server.BlockchainService.AddPeer:output_type -> server.AddPeerResponse
	13, // 22: server.BlockchainService.GetPeers:output_type -> server.GetPeersResponse
